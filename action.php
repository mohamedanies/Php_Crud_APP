<?php
   ...
   if(isset($_POST['add'])){
      ...
      $_SESSION['response']="OK , record added succesfully";
   ...
   if(isset($_GET['delete'])){
      $id=$_GET['delete'];
       ...
       //to delete the image from uploads folder too
      ...
      header('location:index.php');
      $_SESSION['response']="OK , record Deleted! succesfully";
